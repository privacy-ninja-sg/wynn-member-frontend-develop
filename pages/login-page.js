...
export default function LoginPage() {
    ...
    useEffect(() => {
        if(_.isEmpty(cookies)) {
            ...
            return router.push('/user-account-page')
        }
    }, [])
    const handleSubmit = async (event) => {
        ...
        return userService.login(data.username, data.password).then((res) => {
            const resData = res.data
            setCookie("username", JSON.stringify(data.username), { path: '/' })
            setCookie("access_token", JSON.stringify(resData.access_token), { path: '/' })
            router.reload('/user-account-page');
        }).catch(() => {
            alert("กรุณาตรวจสอบชื่อผู้ใช้งานและรหัสการเข้าใช้งานอีกครั้ง")
        })
            ...
            <div className="relative min-h-screen flex flex-col sm:justify-center items-center">
                ...
                <div className="relative sm:max-w-sm w-full">
                    ...
                    <form onSubmit={handleSubmit} className="mt-8">
                        ...
                        <div className="form-group mt-6 mx-8">
                            <input
                                type="password"
                        ...
                        {/* <div className="form-group mt-7 mx-8">
                        ...
                        <div className="mt-7">
                            <button type='submit' className="bg-[url('/img/login.png')] bg-auto bg-no-repeat bg-center w-full h-32" ></button>
                        </div>
